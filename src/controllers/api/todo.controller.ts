...
export class TodoController {
    ...
    async index(req: TypedQuery<FilterTodoListInterface>, res: Response, next: NextFunction) {
        try {
    ...
    async add(req: TypedRequest<CreateTodoDto>, res: Response, next: NextFunction) {
        try {
    ...
    async update(req: TypedRequest<CreateTodoDto, IdParam>, res: Response, next: NextFunction) {
        try {
    ...
    async changeStatus(req: TypedRequest<CreateTodoDto, IdParam>, res: Response, next: NextFunction){
        try{
