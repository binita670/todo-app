...
<tr>
    ...
    <td>${moment.utc(todo.deadline).format('MMM Do YYYY, h:mm:ss a')}</td>
    <td>
            ...
            <form class="edit-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <span style="color: red">*</span>
                        <input type="text" class="form-control datetimepicker" name="deadline"  value="${moment.utc(todo.deadline).format('YYYY/MM/DD HH:mm')}" required>
                    </div>
                </div>
